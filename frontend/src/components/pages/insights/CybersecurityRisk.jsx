    ...
    <main className="optimized-page pt-24 pb-12 px-gutter bg-background min-h-[70vh]">
      <section className="relative -mt-24 md:-mt-8 min-h-[620px] lg:min-h-[660px] flex items-center pt-24 md:pt-20 pb-12 overflow-hidden bg-white -mx-gutter">
                          <div className="absolute inset-0 z-0">
                              <img src={assetPath("/asset/insight/cyber_security/1-optimized.webp")} alt="Cyber security enterprise risk monitoring and secure platform operations" className="w-full h-full object-cover object-center opacity-85 blur-[2px] md:blur-[1px] scale-[1.01]" fetchPriority="high" loading="eager" decoding="async" />
                      ...
                      <section className="max-w-container-max mx-auto py-10 md:py-12">
                          <div className="grid grid-cols-1 xl:grid-cols-[0.48fr_0.52fr] gap-6 lg:gap-8 items-stretch">
                              <div className="relative min-h-[320px] md:min-h-[420px] rounded-2xl overflow-hidden border border-outline-variant/35">
                                  <img src={assetPath("/asset/insight/cyber_security/2-optimized.webp")} alt="Identity and access security operating model" className="absolute inset-0 h-full w-full object-cover object-center" loading="lazy" decoding="async" />
                      ...
                      <section className="max-w-container-max mx-auto py-10 md:py-12">
                          <div className="grid grid-cols-1 lg:grid-cols-[0.58fr_0.42fr] gap-6 lg:gap-8 items-stretch">
                              ...
                              <div className="relative min-h-[300px] rounded-2xl overflow-hidden border border-outline-variant/35">
                                  <img src={assetPath("/asset/insight/cyber_security/3-optimized.webp")} alt="Cloud security architecture and monitoring controls" className="absolute inset-0 h-full w-full object-cover object-center" loading="lazy" decoding="async" />
